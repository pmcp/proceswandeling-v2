        ...
        <div class="grid grid-cols-1 gap-y-20 lg:grid-cols-3 lg:gap-y-0 lg:gap-x-8">
          <div class="flex flex-col bg-white rounded-2xl shadow-xl">
            <div class="flex-1 relative pt-16 px-6 pb-8 md:px-8">
              ...
              <h3 class="text-xl font-medium text-gray-900">Projecten</h3>
            ...
            <div class="p-6 bg-gray-50 rounded-bl-2xl rounded-br-2xl md:px-8">
              <nuxt-link
                to="/projects"
                class="text-base font-medium text-blue-700 hover:text-blue-600">Bekijk de projecten<span aria-hidden="true"> &rarr;</span></nuxt-link>
            </div>
          </div>
          ...
          <div class="flex flex-col bg-white rounded-2xl shadow-xl">
            <div class="flex-1 relative pt-16 px-6 pb-8 md:px-8">
              ...
              <h3 class="text-xl font-medium text-gray-900">Methodiek</h3>
              <p class="mt-4 text-base text-gray-500">Varius facilisi mauris sed sit. Non sed et duis dui leo, vulputate id malesuada non. Cras aliquet purus dui laoreet diam sed lacus, fames.</p>
            </div>
            <div class="p-6 bg-gray-50 rounded-bl-2xl rounded-br-2xl md:px-8">
              <nuxt-link
          ...
          <div class="flex flex-col bg-white rounded-2xl shadow-xl">
            ...
            <div class="p-6 bg-gray-50 rounded-bl-2xl rounded-br-2xl md:px-8">
              <nuxt-link
                to="/contact"
                class="text-base font-medium text-blue-700 hover:text-blue-600">Contacteer ons<span aria-hidden="true"> &rarr;</span></nuxt-link>
            </div>
          </div>
        </div>
      </section>
